...
import ABCalculator from '../src/ab_calculator.js';
...
test('Z-value 0', t => {
  t.is(float.round(ABCalculator()._computeCriticalNormalZValue(0), PRECISION), Z_VALUE['0']);
});
...
test('Z-value 1', t => {
  t.is(float.round(ABCalculator()._computeCriticalNormalZValue(1), PRECISION), Z_VALUE['1']);
});
